...
def hidden_tuning(hidden_size):
    ...
    logger = TensorBoardLogger(f"lightning_logs/hidden_tuning")  # logging results to a tensorboard
    ...
    fig_save_path = f'./fig/hidden_size_{hidden_size}'
...
for hidden_size in [12 ,16, 24, 30, 32, 48, 52, 64, 82 , 96, 128]:
