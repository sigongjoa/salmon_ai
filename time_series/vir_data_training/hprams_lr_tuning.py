...
def lr_tuning(lr):
    ...
    save_path = f"results_tuning/trail_{config.trail_num}/{config.training_count}"
    ...
    logger = TensorBoardLogger(f"lightning_logs/trail_config_hparams_tuning/{config.training_count}")
